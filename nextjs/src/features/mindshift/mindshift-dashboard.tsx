 ...
 * dependency on this app's page layout/nav/auth-guard. Drop it into any page in a host app;
 * it only needs a React Query provider and a signed-in user (cookie-based Supabase session).
 */
